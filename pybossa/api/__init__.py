...
from pybossa.api.project_by_product import ProjectByProductAPI
...
register_api(ProjectByProductAPI, 'api_projectbyproduct', '/projectbyproduct', pk='key', pk_type='string')
