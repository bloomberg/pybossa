...
"""
# TODO - ImportError: cannot import name 'auth_plugin' from 'novaclient'
#  (/home/pybossa/pybossa/env3/lib/python3.9/site-packages/novaclient/__init__.py)
# refer to https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=896224
...
#
#
# class RackspaceUploader(Uploader):  # pragma: no cover
#
