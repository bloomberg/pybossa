...
class UserPrefMetadataForm(Form):
    ...
    profile = TextAreaField(
        lazy_gettext("<div>Task Preferences</div>"
                     ...
                     "Must not include sensitive nor personally identifiable information, e.g., name, email address, phone number, UUID, race, gender, health or financial information.</div>"),
