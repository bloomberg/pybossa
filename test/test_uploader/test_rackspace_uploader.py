...
# Comment out for now: will do a cleanup in
# https://jira.prod.bloomberg.com/browse/RDISCROWD-4743
...
# from test.test_uploader import cloudfiles_mock, fake_container
#
#
